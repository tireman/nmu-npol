...
void NpolBeamline::ConstructBeamlineUpper() {
  G4double len= 11.37*m, inDia = 0.0*cm, outDia = 4.0*cm;
...
void NpolBeamline::ConstructBeamlineUpperInner() {
  G4double len= 11.37*m, inDia = 0.0*cm, outDia = 3.0*cm;
...
void NpolBeamline::ConstructBeamlineDownInner() {
  ...
  G4double len= 8.28*m, inDia = 0.0*cm, outDia = 3.0*cm;
...
G4VPhysicalVolume *NpolBeamline::Construct(G4LogicalVolume *motherLV) {
  ...
  PlaceCylindrical(BeamlineUpperLV, motherLV, "BeamLineUpper", -11.475*m,0,0);
  ...
  PlaceCylindrical(BeamlineExitInnerLV, BeamlineExitLV, "BeamLineExitInner", 
      0,0,0);
