...
void NpolHallShell::ConstructHallShellRoof() {
  ...
  G4Sphere *HallShellRoof = new G4Sphere("HallShellRoof",40.0*m, 41.0*m, 
        0.0*deg, 360.0*deg, 0.0*deg, 37.0*deg);
