...
// We want taggedEvents variable from NpolAnalysis code which is total QE neutrons entering NPOL.
  ...
  TCanvas *recoilMomentumElastic = new TCanvas("eventDiagnostics","Event Diagnostics (Elastic Events)", 1000, 1200);
  recoilMomentumElastic->Divide(2,2,0.0001, 0.00001,0);
  recoilMomentumElastic->cd(1);
  ...
  h_NP_RecoilMomentum_Elastic->SetTitle("Momentum Difference");
  h_NP_RecoilMomentum_Elastic->DrawCopy();
  TCanvas *recoilMomentumInElastic = new TCanvas("eventDiagnosticsInElastic","Event Diagnostics (InElastic Events)", 1000, 1200);
  recoilMomentumInElastic->Divide(2,2,0.0001, 0.00001,0);
  recoilMomentumInElastic->cd(1);
  ...
  h_NP_RecoilMomentum_InElastic->SetTitle("Momentum Difference");
  h_NP_RecoilMomentum_InElastic->DrawCopy();
  TCanvas *recoilMomentumQuasiElastic = new TCanvas("eventDiagnosticsQuasiElastic","Event Diagnostics (QuasiElastic Events)", 1000, 1200);
  recoilMomentumQuasiElastic->Divide(2,2,0.0001, 0.00001,0);
  recoilMomentumQuasiElastic->cd(1);
  ...
  h_NP_RecoilMomentum_QuasiElastic->SetTitle("Momentum Difference");
  ...
  recoilMomentumElastic->Write();
  recoilMomentumInElastic->Write();
  recoilMomentumQuasiElastic->Write();
