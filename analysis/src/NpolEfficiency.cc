...
int main(int argc, char *argv[]) {
  ...
  txtOut.open("/dev/null");
	...
	TH2F *h_dEoverE_TopHigh = new TH2F("dEoverE_Top", "dE over E for top array - HIGHEST PV ONLY", 600,0,150,80,0,20);
	TH2F *h_dEoverE_BotHigh = new TH2F("dEoverE_Bot", "dE over E for bottom array - HIGHEST PV ONLY", 600,0,150,80,0,20);
	TH2F *h_dEoverEtop = new TH2F("dEoverEtop", "dE over E for top array", 600,0,150,80,0,20);
	TH2F *h_dEoverEbot = new TH2F("dEoverEbot", "dE over E for bottom array", 600,0,150,80,0,20);
	TH2F *h_dEoverEtop3 = new TH2F("dEoverEtop3", "dE over E for top array in section 3", 600,0,150,80,0,20);
	TH2F *h_dEoverEbot3 = new TH2F("dEoverEbot3", "dE over E for bottom array in section 3", 600,0,150,80,0,20);
