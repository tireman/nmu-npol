...
void NpolPolarimeter6Layer::ConstructTopVetoArray(G4LogicalVolume *motherLV) {
  ...
  ImprintPlate(TopVetoArray1, motherLV, 0.0*m, 0.32*m, -2.155*m, 0.0*deg); // -2.13 cm
  ImprintPlate(TopVetoArray1, motherLV, 0.0*m, 0.42*m, -0.855*m, 0.0*deg);  // -0.83 cm
  ImprintPlate(TopVetoArray2, motherLV, 0.0*m, 0.52*m, 0.565*m, 0.0*deg);  // 0.59 cm
...
void NpolPolarimeter6Layer::ConstructBottomVetoArray(G4LogicalVolume *motherLV) {
  ...
  ImprintPlate(BottomVetoArray1, motherLV, 0.0*m, -0.32*m, -2.155*m, 0.0*deg); // -2.13 cm
  ImprintPlate(BottomVetoArray1, motherLV, 0.0*m, -0.42*m, -0.855*m, 0.0*deg); // -0.83 cm
  ImprintPlate(BottomVetoArray2, motherLV, 0.0*m, -0.52*m, 0.565*m, 0.0*deg);  // 0.59 cm
